...
goimports() {
    ...
    go run golang.org/x/tools/cmd/goimports -w xo_gen/enum/*
    go run golang.org/x/tools/cmd/goimports -w xo_gen/table/*
    go run golang.org/x/tools/cmd/goimports -w xo_gen/repo/*
    go run golang.org/x/tools/cmd/goimports -w xo_gen/rlts/*
    go run golang.org/x/tools/cmd/goimports -w xo_gen/*.go
